...
using UnityEngine.UI;
    ...
    public class CityCharacter : MonoBehaviour
    {
        ...
        public void OnClickButton(Image product)
        {
            ...
            else if (product.sprite == Player.Meat.sprite)              // событие для клика по локации
            {
        ...
        void UpgradeLvLProductCity(Image product)                             // Улучшение уровня продукции локации
        {
            if (product.sprite == Player.Bread.sprite)
            {
                _lvlProductBread++;
        ...
        Sprite NextProductImage(int no)                            //   работа над спрайтами продукции локации
        {
        ...
        private SaveDate.CityProfile GetSaveCityCharacters()                      // сохраняемые значения локации
        {
